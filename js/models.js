...
// CLASS
    ...
    class User {
        ...
        static viewUserById(id) {
            for (let i = 0; i < users.length; i++) {
                if (users[i].id == id) {
                    modalUserName.value= users[i].userName
                    modalUserEmail.value = users[i].userEmail
                    modalUserPassword.value =  users[i].userPassword
                    // fine value
                    modalUserPermissions.value =  users[i].userPermissions
                    modalUserPhoto.setAttribute("src", users[i].userPhoto)
                }                  
            }
        }
